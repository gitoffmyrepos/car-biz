...
const testimonials = [
  {
    ...
    role: 'Business Owner',
    content: 'FX Weekly made it incredibly easy to get a premium vehicle without the long-term commitment. The weekly payment structure fits perfectly with my business cash flow.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Having access to premium vehicles has elevated my professional image. The maintenance is handled completely by FX Weekly - I just drive and focus on my work.',
    rating: 5,
    image: '/api/placeholder/80/80',
  },
];
