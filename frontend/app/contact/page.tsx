        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/contact" className="text-[#C5A572] font-medium">
                Contact
              </Link>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                {isSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <Link
                      href="/"
                      className="inline-block bg-[#C5A572] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#B39562] transition-colors"
                    >
                      Return to Home
                    </Link>
                  </div>
                  ...
                  <>
                    <h2 className="text-2xl font-bold text-[#1A1A1A] mb-2">Inquiry Form</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          } focus:ring-2 focus:ring-[#C5A572] focus:border-transparent transition-colors`}
                      ...
                      <div>
                        ...
                        <select
                          ...
                          } focus:ring-2 focus:ring-[#C5A572] focus:border-transparent transition-colors bg-white`}
                        >
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className={`w-full px-4 py-3 rounded-lg border ${
                            errors.timeframe ? 'border-red-500 bg-red-50' : 'border-gray-300'
                          } focus:ring-2 focus:ring-[#C5A572] focus:border-transparent transition-colors bg-white`}
                        >
                        ...
                        {errors.timeframe && (
                          <p className="mt-2 text-sm text-red-600">{errors.timeframe}</p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#C5A572] focus:border-transparent transition-colors resize-none"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-6">Quick Contact</h3>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#1A1A1A] font-medium">info@fxweekly.com</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#1A1A1A] font-medium">123 Main Street</p>
              ...
              {/* Why Choose Us */}
              <div className="bg-gradient-to-br from-[#1A1A1A] to-[#2D2D2D] rounded-2xl shadow-lg p-6 text-white">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-[#C5A572] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
              ...
              {/* Response Time */}
              <div className="bg-[#C5A572]/10 rounded-2xl p-6 border border-[#C5A572]/20">
                <div className="flex items-center space-x-3 mb-3">
                  <svg className="w-6 h-6 text-[#C5A572]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <h3 className="text-lg font-bold text-[#1A1A1A]">Fast Response</h3>
                </div>
      ...
      <section className="py-16 bg-[#F8F5F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/faq"
              className="bg-[#1A1A1A] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#2D2D2D] transition-colors"
            >
              View FAQ
            </Link>
          </div>
