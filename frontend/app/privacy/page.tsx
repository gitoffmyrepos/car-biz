      ...
      <main id="main">
        ...
        <section className="ed-section border-t ed-hairline pt-32">
          <div className="ed-container">
            ...
            <h1 className="ed-h1 mt-5 mb-6">Privacy Policy</h1>
            ...
            <div className="ed-card p-6 md:p-8">
              ...
              <div className="mb-12 p-6 bg-ink-card border ed-hairline">
                <h2 className="text-xl font-bold text-white mb-4 flex items-center">
                  <svg className="w-6 h-6 text-gold-light mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <ul className="space-y-2 ed-muted">
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-gold-light mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <section id="information-sharing" className="mb-10">
                ...
                <div className="ed-muted space-y-4 pl-11">
                  <div className="bg-ink-card border-l-2 border-gold-light p-4 mb-4">
              ...
              <section id="gps-tracking" className="mb-10">
                ...
                <div className="ed-muted space-y-4 pl-11">
                  ...
                  <p className="mt-4">
                    For more details, please see our <Link href="/gps-disclosure" className="text-gold-light hover:underline">GPS/Telematics Disclosure</Link>.
                  </p>
                </div>
              </section>
