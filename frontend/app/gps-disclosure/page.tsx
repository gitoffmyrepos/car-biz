      ...
      <section className="bg-gradient-to-r from-[#1A1A1A] to-[#2D2D2D] text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">
            GPS & Telematics <span className="text-[#C5A572]">Disclosure</span>
          </h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12">
            ...
            <section className="mb-10">
              ...
              <div className="text-gray-600 space-y-4 pl-11">
                ...
                <div className="bg-[#F8F5F0] rounded-lg p-4 mt-4">
                  <h3 className="font-semibold text-[#1A1A1A] mb-2">Our Tracking System Monitors:</h3>
            ...
            <section className="mb-10">
              ...
              <div className="text-gray-600 space-y-4 pl-11">
                ...
                <div className="grid md:grid-cols-2 gap-4 mt-4">
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-100">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h3 className="font-semibold text-[#1A1A1A]">Asset Protection</h3>
                    </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-4 border border-green-100">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h3 className="font-semibold text-[#1A1A1A]">Fleet Management</h3>
                    </div>
                  ...
                  <div className="bg-purple-50 rounded-lg p-4 border border-purple-100">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h3 className="font-semibold text-[#1A1A1A]">Mileage Verification</h3>
                    </div>
                  ...
                  <div className="bg-red-50 rounded-lg p-4 border border-red-100">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <h3 className="font-semibold text-[#1A1A1A]">Emergency Assistance</h3>
                    </div>
                ...
                <div className="mt-6">
                  <h3 className="font-semibold text-[#1A1A1A] mb-2">Additional Purposes:</h3>
            ...
            <section className="mb-10">
              ...
              <div className="text-gray-600 space-y-4 pl-11">
                ...
                <div className="bg-[#F8F5F0] rounded-lg p-6 mt-4">
                  <h3 className="font-semibold text-[#1A1A1A] mb-4">Your Acknowledgment Includes:</h3>
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-[#C5A572] mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <section className="mb-10">
              ...
              <div className="text-gray-600 space-y-4 pl-11">
                ...
                <p className="mt-4">
                  For more information about how we handle your data, please see our <Link href="/privacy" className="text-[#C5A572] hover:underline">Privacy Policy</Link>.
                </p>
              </div>
            </section>
            ...
            <section className="mb-6">
              ...
              <div className="text-gray-600 space-y-4 pl-11">
                ...
                <div className="bg-[#F8F5F0] rounded-lg p-6 mt-4">
                  <p className="font-semibold text-[#1A1A1A]">FX Weekly Lease - Compliance Team</p>
                  <p>123 Main Street</p>
            ...
            <div className="border-t border-gray-200 pt-8 mt-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                <Link
                  href="/privacy"
                  className="bg-[#C5A572] text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#B39562] transition-colors text-center"
                >
                  Privacy Policy
                </Link>
                <Link
                  href="/terms"
                  className="bg-white text-[#1A1A1A] px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors border border-gray-200 text-center"
                >
                  Terms of Service
                </Link>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/gps-disclosure" className="text-[#C5A572]">GPS Disclosure</Link></li>
