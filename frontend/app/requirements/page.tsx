        ...
        <div className="container-luxury">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/requirements" className="text-luxury-charcoal font-medium transition-colors">
                Requirements
              </Link>
      ...
      <section className="bg-gold-50 py-8 border-b border-gold-200">
        <div className="container-luxury">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16 text-center">
            <div>
              <div className="text-3xl font-bold text-luxury-charcoal">21+</div>
              <div className="text-sm text-muted">Minimum Age</div>
            </div>
            <div className="hidden md:block w-px h-12 bg-gold-300"></div>
            <div>
              <div className="text-3xl font-bold text-luxury-charcoal">Valid License</div>
              <div className="text-sm text-muted">Required</div>
            </div>
            <div className="hidden md:block w-px h-12 bg-gold-300"></div>
            <div>
              <div className="text-3xl font-bold text-luxury-charcoal">Full Coverage</div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-luxury-charcoal">Age & Eligibility</h2>
              </div>
            ...
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-luxury-charcoal">Identification Requirements</h2>
              </div>
              <div className="card p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-bold text-luxury-charcoal mb-3 flex items-center">
                      <span className="w-8 h-8 bg-gold-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3">1</span>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-bold text-luxury-charcoal mb-3 flex items-center">
                      <span className="w-8 h-8 bg-gold-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3">2</span>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-bold text-luxury-charcoal mb-3 flex items-center">
                      <span className="w-8 h-8 bg-gold-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3">3</span>
                      Proof of Address
                    </h4>
                    <ul className="text-sm text-gray-600 space-y-2 ml-11">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-bold text-luxury-charcoal mb-3 flex items-center">
                      <span className="w-8 h-8 bg-gold-500 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3">4</span>
                      Contact Information
                    </h4>
                    <ul className="text-sm text-gray-600 space-y-2 ml-11">
            ...
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-luxury-charcoal">Insurance Requirements</h2>
              </div>
              <div className="card p-6 border-2 border-gold-200">
                <div className="bg-gold-50 rounded-lg p-4 mb-6">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-bold text-gold-800">Important</span>
                  </div>
                ...
                <h4 className="font-bold text-luxury-charcoal mb-4">Required Coverage:</h4>
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-2xl font-bold text-luxury-charcoal">$100K/$300K</div>
                    <div className="text-sm text-muted">Bodily Injury Liability</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-2xl font-bold text-luxury-charcoal">$50K</div>
                    <div className="text-sm text-muted">Property Damage</div>
                  </div>
                  <div className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="text-2xl font-bold text-luxury-charcoal">Full</div>
                    <div className="text-sm text-muted">Comprehensive & Collision</div>
                  </div>
                </div>

                <h4 className="font-bold text-luxury-charcoal mb-4">Insurance Documentation:</h4>
            ...
            <div className="mb-12">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-luxury-charcoal">Payment Requirements</h2>
              </div>
              <div className="card p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-bold text-luxury-charcoal mb-3">Initial Payment</h4>
                  ...
                  <div>
                    <h4 className="font-bold text-luxury-charcoal mb-3">Accepted Payment Methods</h4>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-center">
                        <svg className="w-5 h-5 text-gold-500 mr-3" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="font-bold text-luxury-charcoal mb-4 flex items-center">
                <svg className="w-5 h-5 text-gold-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Additional Notes
      ...
      <section className="section bg-gradient-luxury text-white">
        <div className="container-luxury text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/faq" className="btn btn-outline border-white text-white hover:bg-white hover:text-luxury-charcoal text-lg px-8 py-4 w-full sm:w-auto">
              View FAQ
            </Link>
          </div>
        </div>
