...
STYLE = ("stylized 3D Pixar DreamWorks animated cartoon, big expressive friendly "
         "eyes, warm rounded proportions, cinematic soft warm sunlight, bright, "
         "vibrant, optimistic, hopeful, wholesome, subtle red accents, high quality 3d render")
NEG = ("ugly, deformed, blurry, low quality, watermark, photorealistic, scary, extra "
       "fingers, text, letters, words, writing, captions, numbers, signage, sign, signs, "
       "banner, storefront sign, brand name, building sign, logo, any text anywhere")

CHARA = "Chara, a beautiful young Black woman, slightly round oval face, long black dreadlocks, warm radiant smile"
KELVIN = ("Kelvin, a friendly light-skinned Black man, bald fade haircut with very little hair, "
          "nearly shaved on top with faded sides, full well-groomed beard, a clearly visible dark "
          "brown mole dot in the very center of his forehead, tall broad athletic build, sharp dark "
          "tailored suit with a black shirt, big warm happy genuine smile")
...
SCENES = [
    ...
    ("06_tip",    303, f"{ALEX}, smiling and gesturing as he points the way, enthusiastically telling a friend about a great place that helps new drivers"),
    ("07_lot",    22,  "a bright clean friendly car lot, neat rows of plain unmarked compact cars, a clean modern glass building, no signs and no banners, sunny optimistic day"),
    ...
    ("13_card",   33,  "a clean minimal cinematic background, solid deep charcoal black with a soft subtle warm red glow from the center, empty, elegant, premium, no objects"),
]
